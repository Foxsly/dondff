...
describe('TeamsController', () => {
  ...
  const mockPlayers: ITeamPlayer[] = [
    { teamId: 'uuid-team-1', position: 'QB', playerId: '1', playerName: 'Patrick Mahomes', projectedPoints: null, actualPoints: null },
    { teamId: 'uuid-team-1', position: 'RB', playerId: '2', playerName: 'Derrick Henry', projectedPoints: null, actualPoints: null },
  ];
